...
The normal flow can then be resumed as is said in this <a href="http://blog.scottlowe.org/2015/01/27/using-fork-branch-git-workflow/">nice article</a> on git flows.
Make a new branch
<code style="font-size: 15px;">
...
Now while doing this on my own <a href="https://github.com/infinite-Joy/predictit">predictit repo</a> which I recently open-sourced, I ran into one more trouble. Github doesnt allow files to be more than 50mb. This is not an issue with Bitbucket. So I had to purge my git history because of that using the below command.
